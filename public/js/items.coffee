...
,
  type: 'Soup'
  name: 'Hot and Sour Soup (Low Carb)'
  description: 'Another healthier version of one of my favourite Chinese take-out dishes.  Great for clearing out those sinuses too!'
  ingredients: 'mushrooms, chicken, egg, carrot, green onion, ginger, chicken bone broth, coconut oil, sesame oil, gluten-free tamari, apple cider vinegar, red pepper flakes, onion powder, garlic powder, potato starch, sea salt, black pepper'
  image: '/img/hot_and_sour_soup.jpg'
,
  type: 'Soup'
  name: 'Green Pea Soup (Autoimmune Protocol Approved)'
  description: 'This bright green soup combines quality bone broth with rich ham and softened vegetables for a silky-sweet finish.'
  ingredients: 'green peas, ham, carrot, onion, mint, chicken bone broth, coconut oil, sea salt, black pepper'
  image: '/img/green_pea_soup.jpg'
]
