...
,
  type: 'Salad'
  name: 'Nicoise Salad (Low Carb)'
  description: 'This salad remains true to the French recipe with hard­boiled eggs, tuna, olives and fresh veggies, but cuts out the potatoes for a lower carb version.'
  ingredients: 'lettuce, tuna, egg, green beans, cherry tomatoes, olives, red onion, olive oil, lemon juice, dijon mustard, thyme, oregano, sea salt, black pepper'
  image: '/img/nicoise.jpg'
,
  type: 'Salad'
...
,
  type: 'Soup'
  name: 'Roasted Tomato Garlic Soup (Low Carb)'
  description: 'Oven roasting the tomatoes with garlic and onions before simmering into a soup makes this extra flavourful.'
  ingredients: 'tomatoes, garlic, onion, chicken bone broth, extra virgin olive oil, ghee, bay leaf, basil, sea salt, black pepper'
  image: '/img/tomato_soup.jpg'
,
  type: 'Soup'
  name: 'Cream of Mushroom Soup (Low Carb)'
  description: 'Coconut milk used in place of cream makes this just as rich and satisfying as any cream of mushroom soup.'
  ingredients: 'mushrooms, garlic, onion, beef bone broth, coconut milk, ghee, parsley, rosemary, sea salt, black pepper'
